...
export default class {
  ...
  handleEditTicket(e, bill, bills) {
    ...
    // Réenregistrement des gestionnaires d'événements – assurez-vous qu'ils ne sont pas attachés plusieurs fois
    $('#icon-eye-d').off('click').on('click', this.handleClickIconEye.bind(this));
